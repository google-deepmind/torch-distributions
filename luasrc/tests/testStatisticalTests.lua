...
function mytest.testChiSquareUniformAccept()
    ...
    -- Chi-square test at 99.9%
    local p = randomkit.chi2Uniform(x, low, up)
...
function mytest.testChiSquareUniformRejectWithinSupport()
    ...
    -- Chi-square test at 99.9%
    p = randomkit.chi2Uniform(x, low, up)
...
function mytest.testChiSquareUniformRejectOutOfSupport()
    ...
    -- Chi-square test at 99.9%
    p = randomkit.chi2Uniform(x, 0, 10)
...
function mytest.testChiSquareCDF()
    ...
    -- Chi-square test at 99.9%
    local p = randomkit.chi2TestCDF(x, cdf, {})
    tester:assert(p > 0.001, 'Chi-square test rejects a sample from a uniform distribution')
    ...
    -- Test invalid calls
    tester:assertError(function() randomkit.chi2TestCDF() end, "chi2TestCDF should error when given no arguments")
    tester:assertError(function() randomkit.chi2TestCDF(torch.Tensor()) end, "chi2TestCDF should error when given one argument")
    tester:assertError(function() randomkit.chi2TestCDF(torch.Tensor(), function() end) end, "chi2TestCDF should error when given two arguments")
    tester:assertError(function() randomkit.chi2TestCDF({}, function() end, {}) end, "chi2TestCDF should error when given incorrectly typed first argument")
    tester:assertError(function() randomkit.chi2TestCDF(torch.Tensor(), {}, {}) end, "chi2TestCDF should error when given incorrectly typed second argument")
    tester:assertError(function() randomkit.chi2TestCDF(torch.Tensor(), function() end, 3) end, "chi2TestCDF should error when given incorrectly typed third argument")
end
