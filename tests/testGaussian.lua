...
function myTest.gaussianPDF()
    tester:assertalmosteq(randomkit.gaussianPDF(-0.5, 0, 1), 0.352065326764300, 1e-15)
    tester:assertalmosteq(randomkit.gaussianPDF(0,    0, 1), 0.398942280401433, 1e-15)
    tester:assertalmosteq(randomkit.gaussianPDF(1,    0, 1), 0.241970724519143, 1e-15)
    tester:assertalmosteq(randomkit.gaussianPDF(4,    0, 1), 0.000133830225765, 1e-15)
    tester:assertalmosteq(randomkit.gaussianPDF(-0.5, 2, 3), 0.093970625136768, 1e-15)
    tester:assertalmosteq(randomkit.gaussianPDF(0,    2, 3), 0.106482668507451, 1e-15)
    tester:assertalmosteq(randomkit.gaussianPDF(1,    2, 3), 0.125794409230998, 1e-15)
...
function myTest.gaussianCDF()
    ...
    tester:assertalmosteq(randomkit.gaussianCDF(1,    0, 1), 0.841344746068543, 1e-15)
    tester:assertalmosteq(randomkit.gaussianCDF(4,    0, 1), 0.999968328758167, 1e-15)
    tester:assertalmosteq(randomkit.gaussianCDF(-0.5, 2, 3), 0.202328380963643, 1e-15)
    tester:assertalmosteq(randomkit.gaussianCDF(0,    2, 3), 0.252492537546923, 1e-15)
    tester:assertalmosteq(randomkit.gaussianCDF(1,    2, 3), 0.369441340181764, 1e-15)
    tester:assertalmosteq(randomkit.gaussianCDF(4,    2, 3), 0.747507462453077, 1e-15)
end
