...
function myTest.cauchyLogPDF()
    tester:assertalmosteq(randomkit.cauchyLogPDF(-0.5, 0, 1), math.log(0.254648), 1e-5)
    tester:assertalmosteq(randomkit.cauchyLogPDF(0,    0, 1), math.log(1.0/math.pi), 1e-5)
    tester:assertalmosteq(randomkit.cauchyLogPDF(1,    0, 1), math.log(0.5/math.pi), 1e-5)
    tester:assertalmosteq(randomkit.cauchyLogPDF(4,    0, 1), math.log(0.0187241), 1e-5)
    tester:assertalmosteq(randomkit.cauchyLogPDF(-0.5, 2, 3), math.log(0.062618), 1e-5)
    tester:assertalmosteq(randomkit.cauchyLogPDF(1,    2, 3), math.log(0.095493), 1e-5)
    tester:assertalmosteq(randomkit.cauchyLogPDF(2,    2, 3), math.log(0.106103), 1e-5)
    tester:assertalmosteq(randomkit.cauchyLogPDF(4,    2, 3), math.log(0.0734561), 1e-5)
end
